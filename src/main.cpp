...
unsigned int AVIsendCANAddress = 0x2C0;
unsigned int DPIsendCANAddress1 = 0x2C2;
unsigned int DPIsendCANAddress2 = 0x2C4;
unsigned int DPOrxCANAddress1 = 0x2D0;
unsigned int DPOrxCANAddress2 = 0x2D2;
unsigned int KeepAliveCANAddress = 0x2C6;
...
void SendKeepAlive() {
    byte KeepAlive[5] = { 0X10, 0x0A, 0x0A, 0x01, 0x00 };
